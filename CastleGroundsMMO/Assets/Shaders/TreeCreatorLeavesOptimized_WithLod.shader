...
Shader "Hidden/Nature/Tree Creator Leaves Optimized WITH LOD" {
Properties {
...
CGPROGRAM
#pragma multi_compile SPAWNING_IN_CLIP_OFF SPAWNING_IN_CLIP_ON
...
void surf (Input IN, inout LeafSurfaceOutput o) {
	...
	screenUV *= float2(8, 6);
	//Clipping
	clip(1 - tex2D(_Detail, screenUV).rgb * 2 - UNITY_ACCESS_INSTANCED_PROP(_Distance_arr, _Distance));
